...
// texture parameters control
bool mag_linear = true;
bool min_linear = true;
bool wrap_mirror = true;  // change to bool haseye
...
void handleTexParameter()
{
	...
	if (wrap_mirror)   // change to texture transform
	{
...
int main(int argc, char **argv)
{
	...
	// create window
	GLFWwindow* window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, "109061534_HW3", NULL, NULL);
	if (window == NULL)
	{
